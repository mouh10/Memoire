    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('FORMULAIRE CLIENT') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="/Aded-Client" method="POST" role="form text-left">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'AJOUTER CLIENT' }}</button>
                    </div>
                </form>
