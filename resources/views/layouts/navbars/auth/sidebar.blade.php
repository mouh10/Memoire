<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('Acceuil') }}">
            <img src="../assets/img/favicon.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">MANDEL COUTURE</span>
        </a>
    ...
    <div class="w-auto" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('Acceuil') ? 'active' : '') }}" href="{{ url('Acceuil') }}">
            ...
            @if(auth()->user() != null and auth()->user()->idrole != 3)
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">COMMANDES</h6>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ (Request::is('Nouvelle-Commande') ? 'active' : '') }} " href="{{ url('Nouvelle-Commande') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">NOUVELLE COMMANDE</span>
                </a>
            </li>
            @endif
            @if(auth()->user() != null and auth()->user()->idrole == 4)
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Liste-Commande') ? 'active' : '') }}" href="{{ url('Liste-Commande') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('Liste-Commande') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                    </div>
            ...
            @if(auth()->user() != null and auth()->user()->idrole == 3)
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Mes-Taches') ? 'active' : '') }}" href="{{ url('Mes-Taches') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('Mes-Taches') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">MES TACHES</span>
                </a>
            </li>
            @endif

            @if(auth()->user() != null and auth()->user()->idrole == 1)
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Gestion-Commande') ? 'active' : '') }}" href="{{ url('Gestion-Commande') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Gestion-Employer') ? 'active' : '') }}" href="{{ url('Gestion-Employer') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">GESTION EMPLOYER</span>
                </a>
            </li>

            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Gestion-Client') ? 'active' : '') }}" href="{{ url('Gestion-Client') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Gestion-Model') ? 'active' : '') }}" href="{{ url('Gestion-Model') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">GESTION MODELS</span>
                </a>
            </li>

            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('Gestion-Categorie') ? 'active' : '') }}" href="{{ url('Gestion-Categorie') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">GESTION CATEGORIES</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Creer-Compte">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">CREER COMPTE</span>
                </a>
            </li>
            @endif
        </ul>
