    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
          <h5 class="mt-3 mb-0">Parametrage</h5>
          <p>Voici les differents Options.</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">Choisir la Couleur Qui Vous Convient.</p>
        </div>
        <div class="d-flex">
        ...
        <!-- Navbar Fixed -->
        <div class="mt-3">
          <h6 class="mb-0">Fixer la Bar de Navigation</h6>
        </div>
