                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="/Accepter" method="POST">
                                            ...
                                            <button type="submit" class="mx-3 border-0 bg-transparent" data-bs-toggle="tooltip" data-bs-original-title="ACCEPTER">
                                        ...
                                        <form action="" method="POST">
                                            @csrf
                                            <input type="hidden" name="Id" value="{{$C->id}}" />
                                            <button type="submit" class="mx-3 border-0 bg-transparent" data-bs-toggle="tooltip" data-bs-original-title="TERMINER">
